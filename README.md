...
# 画面
 - 初期画面
   ![初期画面](screenshots/screenshot20260116-main01.png)

 - 分割したファイルを変換した後
   ![分割したファイルを変換した後](screenshots/screenshot20260116-main02.png)

 - 出力されたQRコード
   ![出力されたQRコード](screenshots/screenshot20260116-main_result.png)

 - 画像生成
   ![画像生成](screenshots/screenshot20260116-createimage.png)
...
3. 変換対象リストのエラー補正レベル(ECL)を選択します。L→M→Q→Hの順でQRコードの汚損に強くなりますが、
   ...
   省略した場合、Lが選択されます。
4. 変換対象リストのシート名に出力先シート名を入力します。省略した場合、自動的にシート名が記載されます。
...
5. [要素位置]を入力します。
   ...
   省略した場合、4pixel角の黒四角で画像を生成します。
     ...
     - 色が薄い場合、QRコードリーダーが正常に読み取れないでしょう。
